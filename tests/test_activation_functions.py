...
class TestActivationFunctions(unittest.TestCase):
    def test_tanh(self):
        ...
        # derivative
        self.assertEqual(test_function.derivative(0), 1.0)
        self.assertEqual(test_function.derivative(0.5), 1 - tanh(0.5) ** 2)
    ...
    def test_identity(self):
        ...
        # derivative
        self.assertEqual(test_function.derivative(0), 1.0)
        self.assertEqual(test_function.derivative(0.5), 1.0)
    ...
    def test_threshold(self):
        ...
        # derivative
        self.assertEqual(test_function.derivative(-0.5), 0.0)
        self.assertEqual(test_function.derivative(0.5), 0.0)
    ...
    def test_logistic(self):
        ...
        # derivative
        self.assertEqual(test_function.derivative(0), 0.25)
        self.assertEqual(test_function.derivative(0.5), (1.0 / (1.0 + exp(0.5))) * (1 - (1.0 / (1.0 + exp(0.5)))))
    ...
    def test_exponential(self):
        ...
        # derivative
        self.assertEqual(test_function.derivative(0), 1.0)
        self.assertEqual(test_function.derivative(0.5), exp(0.5))
    ...
    def test_reciprocal(self):
        ...
        # derivative
        self.assertEqual(test_function.derivative(0.1), -100)
        self.assertEqual(test_function.derivative(0.5), -4)
    ...
    def test_square(self):
        ...
        # derivative
        self.assertEqual(test_function.derivative(0.1), 0.2)
        self.assertEqual(test_function.derivative(0.5), 1.0)
    ...
    def test_gauss(self):
        ...
        # derivative
        self.assertEqual(test_function.derivative(0.0), 0)
        self.assertEqual(test_function.derivative(0.5), -2 * 0.5 * exp(-0.5 ** 2))
    ...
    def test_sine(self):
        ...
        # derivative
        self.assertEqual(test_function.derivative(0.0), 1.0)
        self.assertEqual(test_function.derivative(0.5), cos(0.5))
    ...
    def test_cosine(self):
        ...
        # derivative
        self.assertEqual(test_function.derivative(0.0), 0.0)
        self.assertEqual(test_function.derivative(0.5), -sin(0.5))
    ...
    def test_elliot(self):
        ...
        # derivative
        self.assertEqual(test_function.derivative(0.0), ((fabs(0) + 1) + 0) / ((fabs(0) + 1) ** 2))
        self.assertEqual(test_function.derivative(0.5), ((fabs(0.5) + 1) + 0.5) / ((fabs(0.5) + 1) ** 2))
    ...
    def test_arctan(self):
        ...
        # derivative
        self.assertEqual(test_function.derivative(0.0), 2.0 / ((1 + 0.0 ** 2) * pi))
        self.assertEqual(test_function.derivative(0.5), 2.0 / ((1 + 0.5 ** 2) * pi))
