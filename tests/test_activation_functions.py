...
class TestActivationFunctions(unittest.TestCase):
    def test_tanh(self):
        ...
        self.assertEqual(test_function(0, None), 0.0)
        self.assertEqual(test_function(0.5, None), tanh(0.5))
        # derivative
    ...
    def test_identity(self):
        ...
        self.assertEqual(test_function(0, None), 0.0)
        self.assertEqual(test_function(0.5, None), 0.5)
        # derivative
    ...
    def test_threshold(self):
        ...
        self.assertEqual(test_function(0, None), 0.0)
        self.assertEqual(test_function(0.5, None), 1)
        # derivative
    ...
    def test_logistic(self):
        ...
        self.assertEqual(test_function(0, 0), 1.0 / (1.0 + exp(0)))
        self.assertEqual(test_function(0.5, 0), 1.0 / (1.0 + exp(-0.5)))
        # derivative
    ...
    def test_exponential(self):
        ...
        self.assertEqual(test_function(0, None), 1.0)
        self.assertEqual(test_function(0.5, None), exp(0.5))
        # derivative
    ...
    def test_reciprocal(self):
        ...
        self.assertEqual(test_function(1, None), 1.0)
        self.assertEqual(test_function(0.5, None), 2)
        # derivative
    ...
    def test_square(self):
        ...
        self.assertEqual(test_function(0, None), 0.0)
        self.assertEqual(test_function(0.5, None), 0.25)
        # derivative
    ...
    def test_gauss(self):
        ...
        self.assertEqual(test_function(0, None), 1)
        self.assertEqual(test_function(0.5, None), exp(-0.5 ** 2))
        # derivative
    ...
    def test_sine(self):
        ...
        self.assertEqual(test_function(0, None), 0.0)
        self.assertEqual(test_function(0.5, None), sin(0.5))
        # derivative
    ...
    def test_cosine(self):
        ...
        self.assertEqual(test_function(0, None), 1.0)
        self.assertEqual(test_function(0.5, None), cos(0.5))
        # derivative
    ...
    def test_elliot(self):
        ...
        self.assertEqual(test_function(0, None), 0.0)
        self.assertEqual(test_function(-0.5, None), -0.5 / (1 + abs(-0.5)))
        # derivative
    ...
    def test_arctan(self):
        ...
        self.assertEqual(test_function(0, None), 0.0)
        self.assertEqual(test_function(0.5, None), 2 * atan(0.5) / pi)
        # derivative
