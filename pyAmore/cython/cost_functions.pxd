...
cdef class AdaptLmsCostFunction(CostFunction):
    ...
    cdef RealNumber derivative(AdaptLmsCostFunction self, RealNumber prediction, RealNumber target)
...
cdef class AdaptLmLsCostFunction(CostFunction):
    ...
    cdef RealNumber derivative(AdaptLmLsCostFunction self, RealNumber prediction, RealNumber target)
...
cdef class BatchLmsCostFunction(CostFunction):
    ...
    cdef RealNumber derivative(BatchLmsCostFunction self, RealNumber prediction, RealNumber target)
